...
These numbers refer to the Draft V2 transfer-action manuscript package. The
descriptive filenames distinguish them from the repository's legacy Phase 3
`fig5_mechanism.png` and `fig6_sdl_prior.png` outputs.
...
- Bridge authorization: at least two feasible route alternatives, a designable paired contrast, recorded nonnegative EVSI and cost, and strict `EVSI > cost`; missing route data, failed falsifiers, or an interval wholly on one side of the endpoint threshold cannot be rescued by a bridge.
